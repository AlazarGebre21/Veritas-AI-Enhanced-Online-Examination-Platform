    ...
    <div className="space-y-6">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-3 py-2.5 text-[14px] border border-[#ddd] rounded-micro focus:outline-none focus:border-notion-blue focus:ring-2 focus:ring-notion-blue/20 transition-all placeholder:text-warm-gray-300"
        />
      </div>
